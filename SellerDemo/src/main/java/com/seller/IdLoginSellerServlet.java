...
@WebServlet("/IdLoginSellerServlet")
public class IdLoginSellerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isTrue;  
		isTrue =SellerDBUtil.validateloginid(sid);  // call validate method
		
		if(isTrue== true)
		{
			List<Seller1d> sd1Details = SellerDBUtil.getsellerloginid(sid); 
