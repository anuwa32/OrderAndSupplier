...
<title>Sell Details Log</title>

<link rel="stylesheet" type="text/css" href ="styles/sellid.css">
...
<div class="box-area">
       ...
       <br>
         <form action="IdLoginSellerServlet" method="post">
      
      <div class="textbox">
      <label for="oid"><br>Enter Sell Id  :</label>
      <input type ="text" name= "sellid" id="reg" placeholder="Enter the id"   required><br>
      </div>
